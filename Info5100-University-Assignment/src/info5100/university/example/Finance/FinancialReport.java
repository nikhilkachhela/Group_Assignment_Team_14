...
public class FinancialReport {
    ...
    /**
     * Get total students enrolled (alias for consistency)
    ...
    /**
     * Get students who paid in full (alias for consistency)
     * @return paid students count
     */
    ...
    /**
     * Calculate payment rate (percentage of students who paid)
     * @return payment rate
     */
    public double getPaymentRate() {
        ...
        return (studentsPaidInFull * 100.0) / totalStudentsEnrolled;
    }
